              ...
              {filteredAwards.length > 0 && (
                <TableFooter>
                    <TableRow>
                        ...
                        <TableCell className="font-bold text-blue-600 dark:text-blue-400">{totalNorth}</TableCell>
                        <TableCell className="font-bold text-red-600 dark:text-red-400">{totalSouth}</TableCell>
